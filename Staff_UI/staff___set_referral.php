                                        ...
                                        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-btn">
                                                    <a href="staff___search-students.php"><button tabindex="-1" class="btn btn-primary btn-md" type="button">Search</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" row">
                                        ...
                                        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-btn">
                                                    <a href="staff___search-staff.php"><button tabindex="-1" class="btn btn-primary btn-md" type="button">Search</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
