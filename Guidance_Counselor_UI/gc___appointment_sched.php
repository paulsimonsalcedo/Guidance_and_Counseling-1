...
<body>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="breadcome-menu">
                  ...
                  <li><span class="bread-blod">Set Appointment Schedule</span>
                  </li>
                </ul>
              </div>
            </div>
  ...
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    <div id="SET_APPOINTMENT_SCHED" class="modal modal-edu-general default-popup-PrimaryModal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header header-color-modal bg-color-1">
            <h4 class="modal-title">Set Appointment Schedule</h4>
              ...
              <div class="form-group-inner">
                <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <label class="login2 pull-right">Slots Available</label>
                  </div>
                  <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <input type="text" class="form-control" placeholder="Enter Slots" />
                  </div>
                </div>
              </div>
          ...
          <div class="sparkline13-list">
            <div class="sparkline13-hd">
              <div class="main-sparkline13-hd">
                <h1>Set Appointment<span class="table-project-n"> Schedule</span> Table</h1>
              </div>
                ...
                <div id="toolbar">
                  ...
                  <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">
                      <!-- Guidance Counselor -->
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#SET_APPOINTMENT_SCHED">
                ...
                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                  <thead>
                    <tr>
                      ...
                      <th data-field="set_appointment_date">Date</th>
                      <th data-field="set_appointment_slots">Number of Slots Available</th>
                      <th data-field="set_appointment_edit">Edit</th>
                      <th data-field="set_appointment_delete">Delete</th>
