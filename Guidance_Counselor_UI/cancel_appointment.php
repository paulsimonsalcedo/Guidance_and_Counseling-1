                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><span class="bread-blod">Reason to Cancel</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="sparkline13-list">
                        ...
                        <form action="" method="POST">
                          <div class="modal-body">
                            <input type="hidden" name="" id="ref_id" value="<?php echo $app_id; ?>">
                            <br>
                            <br>
                            <br>
                            ...
                            <div class="form-group-inner">
                                <div class="row">
                                    ...
                                    <div class="form-group res-mg-t-15 col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                        <textarea placeholder="Reason for Cancelling Appointment" name="reason"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="cancel_app" class="btn btn-primary btn-md">Save</button>
                        </div>
                    </form>
