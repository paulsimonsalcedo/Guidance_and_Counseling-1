                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><span class="bread-blod">SHS Reports</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Senior High School<span class="table-project-n"> Reports</span> </h1>
                            </div>
                                ...
                                <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="appoint_date">DEC</th>
                                            <th data-field="appoint_date">JAN</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>

                                            <td><a href="gc___shs-counseling.php">1. Counseling</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <li>Academic</li>
                                        ...
                                        <tr>
                                            <td>
                                                <li>Psychological First Aid/<br> Crisis Intervention</li>
                                            </td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td>4. Group Guidance</td>
                                        </tr>

                                        <tr>
                                            <td>5. Career Guidance</td>
                                        </tr>
